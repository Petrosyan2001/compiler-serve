...
const Run = (code) => {
    (0, shelljs_1.exec)(`tsp | echo ${JSON.stringify(code)} > ${comands_1.Comands.Node}/main.js`);
    const id = (0, shelljs_1.exec)(`tsp node ${comands_1.Comands.Node}/main.js`).stdout;
    const execute = (0, shelljs_1.exec)(`ts -c ${id}`);
    (0, shelljs_1.exec)(`tsp rm -rf /${comands_1.Comands.Dir}/${comands_1.Comands.Node}/*`);
...
const Install = () => {
    ...
    (0, shelljs_1.exec)(`tsp mkdir -p ${comands_1.Comands.Node}/`);
    (0, shelljs_1.exec)(`tsp touch ${comands_1.Comands.Node}/main.js`);
